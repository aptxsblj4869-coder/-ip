...
const UUID = process.env.UUID || '81504805-279e-4c2b-bd7e-74faee776ad0'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'eyJhIjoiYmU5NzJhZmFjODkyZjJkYjJmYmI3YmFlN2IzNTIwZDIiLCJ0IjoiZmFmYjE3YzAtZTFlYS00Y2UyLWIxMDItMmYyODkyNjEzYWVhIiwicyI6Ik1EWTFObVk1TkdVdE5ETXdNQzAwT0dRMUxXSXhOR0V0TURrMk4yUmlNelUxTmpNdyJ9';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'railway.amsr.de5.net';          // 固定隧道域名,留空即启用临时隧道
